...
**Public app :5060 · internal mgmt :8080 (127.0.0.1 only)**
...
| S3 SSRF | blocklist matches STRINGS — decimal/octal/IPv6-mapped IP literals slip it (`http://2130706433:8080/`) | internal mgmt access |
...
- the webhook refuses redirects, non-80/443/8080 ports, `authorization`
